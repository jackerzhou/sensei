...
public class ScoreAugmentQuery extends AbstractScoreAdjuster {
    ...
    public static interface ScoreAugmentFunction {
         ...
         * @param reader
         * @param jsonParams
         * @throws IOException This method initialize the internal score calculator, e.g., let it know what external data can be used, or anything required for computing the score;
         */
    ...
    private static class AugmentScorer extends Scorer {
        ...
        protected AugmentScorer(BoboSegmentReader reader, Scorer innerScorer,
            ...
            super(innerScorer == null ? null : innerScorer.getWeight());
